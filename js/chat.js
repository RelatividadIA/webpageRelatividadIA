class Chat {
    ...
    subscribeEvents() {
        // Comenta o elimina el evento de submit si ya no lo vas a utilizar
        // this.#promptForm.addEventListener("submit", (event) => {
        //     event.preventDefault();
        //     this.sendMessage();
        // });
    
        // Asume que has añadido una clase 'custom-send-btn' al botón de envío
        const sendButton = this.#promptForm.querySelector('.custom-send-btn');
        if (sendButton) {
        ...
        // Mantén este evento si deseas permitir el envío con la tecla Enter
